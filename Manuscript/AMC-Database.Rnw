...
%   author  = {Schönbrodt, F. D. and Hagemeyer, B. and Brandstätter, V. and Czikmantori, T. and Gröpel, P. and Hennecke, M. and Israel, L. S. F. and Janson, K. and Kemper, N. and Köllner, M. and Kopp, P. M. and Mojzisch, A. and Müller-Hotop, R. and Prüfer, J. and Quirin, M. and Scheidemann, B. and Schiestel, L. and Schulz-Hardt, S. and Sust, L. and Zygar-Hoffmann, C. and Schultheiss, O. C.},
...
% Schönbrodt, F. D., Hagemeyer, B., Brandstätter, V., Czikmantori, T., Gröpel, P., Hennecke, M., Israel, L. S. F., Janson, K., Kemper, N., Köllner, M., Kopp, P. M., Mojzisch, A., Müller-Hotop, R., Prüfer, J., Quirin, M., Scheidemann, B., Schiestel, L., Schulz-Hardt, S., Sust, L., Zygar-Hoffmann, C., Schultheiss, O. C. (in press). Measuring Implicit Motives With the Picture Story Exercise (PSE): Databases of Expert-Coded German Stories, Pictures, and Updated Picture Norms. Journal of Personality Assessment.
...
We embrace the values of openness and transparency in science (\url{http://www.researchtransparency.org/}). We therefore publish all data necessary to reproduce the reported results and provide reproducible scripts for all data analyses reported in this paper. 
...
Parts of this research were funded by the German Research Foundation (SCHO 1334/1-1, Felix Schönbrodt; HA 6884/2-1, Birk Hagemeyer; SCHU 1210/3-1, Oliver Schultheiss; 254142454 / GRK 2070, Stefan Schulz-Hardt and Andreas Mojzisch), the Swiss National Science Foundation (SNSF 100019\_156516, Marie Hennecke and Veronika Brandstätter), and the Templeton Rlg. Trust (TRT 0119, Markus Quirin).
...
This is an unedited manuscript accepted for publication in the \emph{Journal of Personality Assessment}. The manuscript will undergo copyediting, typesetting, and review of resulting proof before it is published in its final form.\newline
\vspace{0.1cm}
...
%\todo[inline,color=blue!20!white]{Unpublished manuscript, draft version 0.3, 2020-01-30.}
}

\keywords{picture story exercise, storytelling, implicit motives, database, pictures, manual coding, machine learning}
...
suppressMessages(print(picPosPlot))
@ 
